...
var CRM = function (options) {
  ...
  this.wfTrigger = options.wfTrigger || false;
};

/**
* Get Fields
* Sends getFields request
* @param {String} module - Zoho module
* @param {Object} params -  Data to send (expressed in JSON)
* @param {Function} callback -
*/
CRM.prototype.getFields = function (module, params, callback) {
  params = params || {};

  module = module.charAt(0).toUpperCase() + module.slice(1);

  var endpoint = module + '/getFields';
...
/**
* Get Users
* Sends getUsers request
* @param {Object} params -  Data to send (expressed in JSON)
* @param {Function} callback -
*/
CRM.prototype.getUsers = function (params, callback) {
  params = params || {};

  this._request('GET', module + '/getUsers', params, callback);
};
...
/**
* Get Related Record
* Sends getRelatedRecords request
* @param {String} module - Zoho module
* @param {Object} params -  Data to send (expressed in JSON)
* @param {Function} callback -
*/
CRM.prototype.getRelatedRecords = function (module, params, callback) {
  params = params || {};

  module = module.charAt(0).toUpperCase() + module.slice(1);

  this._request('GET', module + '/getRelatedRecords', params, callback);
};
...
* Sends searchRecords request
* @param {String} module - Zoho module
* @param {Object} params -  Data to send (expressed in JSON)
* @param {Function} callback -
*/
CRM.prototype.searchRecords = function (module, params, callback) {
  params = params || {};

  if (typeof params !== 'object') {
    return callback({ message: 'Error: Criteria required parameter missing to get record' }, null);
  }

  module = module.charAt(0).toUpperCase() + module.slice(1);

  this._request('GET', module + '/searchRecords', params, callback);
};
...
CRM.prototype._request = function (method, endpoint, params, callback) {
  ...
  params.wfTrigger = this.wfTrigger;

  var options = {
    host: this.host,
    port: this.port,
    path: '/crm/private/json/' + endpoint + '?' + this.sanitizeParams(params),
    method: method,
    headers: {
